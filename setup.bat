...
echo.
echo [2/13] Cloning and setting up cupidcr4wl...
cd /d "%TOOLS_DIR%"
...
echo.
echo [3/13] Cloning and setting up blackbird...
cd /d "%TOOLS_DIR%"
...
echo.
echo [5/13] Setting up user-scanner...
cd /d "%TOOLS_DIR%"
...
echo.
echo [7/13] Setting up theHarvester...
cd /d "%TOOLS_DIR%"
...
echo.
echo [8/13] Setting up Sublist3r...
cd /d "%TOOLS_DIR%"
...
echo.
echo [9/13] Setting up bot virtual environment...
cd /d "%BOT_DIR%"
...
echo.
echo [11/13] Installing Blackbird wrapper...
